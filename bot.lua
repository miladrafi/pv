local bot_api_key = "267550660:AAEOucHBSA3uKyn82x5-VBNvXT8J-PQpctM" --Your telegram bot api key
...
if msg then
	...
	sendMessage(msg.chat.id,'*pm resan Bot*\n\n_Developer_ > [milad rafi](https://telegram.me/mr_bot_admin)\n[My Channel](https://telegram.me/ch_mr_bot)\n\n _Bot Version_ : *4*',true,nil,true)
	
    elseif msg.text:match("^/help") and not is_admin(msg) then
	sendMessage(msg.chat.id,'*راهنمای  پیام رسان مستر بوت:*\n\n\n `-` /nerkh\n`دریافت لیست قیمت ربات های مستر بوت`\n\n`',true,nil,true)
	...
	sendMessage(msg.chat.id,'*لیست قیمت ربات های * [M.r bot ](https://t.me/ch_mr_bot)\n\n =========== \nربات های ضد  اسپم(مدیریت گروه)\n `-` *1 ماهه* > `5000` _تومان_\n `-` *نامحدود* > `15000` _تومان_ \n\n =========== \n ربات هایپر ساز اختصاصی \n هزینه راه اندازی : `5000` _تومان_ \n هزینه سرور ماهیانه : `5000` _تومان_ \n هزینه ماه اول : `10000` _تومان_ \n هزینه ماه های بعد (فقط هزینه سرور ) : `5000` _تومان_ \n\n  =========== \n ربات پیام رسان اختصاصی \n هزینه راه اندازی : `5000` _تومان_ \n هزینه سرور ماهیانه : `5000` _تومان_ \n هزینه ماه اول : `10000` _تومان_ \n هزینه ماه های بعد (فقط هزینه سرور ) : `5000` _تومان_ \n   \n\n توجه :  برای ربات های پیام رسان و هایپر,ماه اول هزینه راه اندازی و سرور را باهم پرداخت میکنید ولی برای ماه های بعد فقط هزینه سرور را پرداخت خواهید کرد .  \n\n جهت سفارس ربات در همین قسمت پیام ارسال کنید .',true,nil,true)
